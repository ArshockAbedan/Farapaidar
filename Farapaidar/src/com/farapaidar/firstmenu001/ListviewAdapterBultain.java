...
public class ListviewAdapterBultain  extends BaseAdapter {
    ...
    public ListviewAdapterBultain(Activity activity, @SuppressWarnings("rawtypes") ArrayList<HashMap> list) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // TODO Auto-generated method stub
                ...
                if (convertView == null)
                {
                    convertView = inflater.inflate(R.layout.bultainlistview_row, null);
                    holder = new ViewHolder();
                    holder.txtFirst = (TextView) convertView.findViewById(R.id.FirstTextBultain);
                    holder.txtSecond = (TextView) convertView.findViewById(R.id.SecondTextBultain);
