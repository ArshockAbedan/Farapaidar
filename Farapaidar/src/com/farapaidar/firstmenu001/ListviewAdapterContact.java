...
public class ListviewAdapterContact  extends BaseAdapter {
    ...
    public ListviewAdapterContact(Activity activity, @SuppressWarnings("rawtypes") ArrayList<HashMap> list) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // TODO Auto-generated method stub
                ...
                if (convertView == null)
                {
                    convertView = inflater.inflate(R.layout.contactlistview_row, null);
